# this file should be used without TSGS and DI, for high dimensional data
    ...
    do
        ...
        do
            ...
            do
                ...
                python main.py --dim_size $dim --sample_size $sample_size --n_exp $N_EXP --effective_rank $e_rank --contamination $CONTAMINATION --method "all" --max_epsilon $MAX_EPSILON --n_epsilon $N_EPSILON --intensity $intensity --contoption dirac
