...
\newcommand{\expectation}[0]{\ensuremath{\mathbb{E}}}                                % expenctation
...
\newcommand{\norm}[1]{\left\Vert #1 \right\Vert}                                     % generic norm symbol
\newcommand{\infnorm}[1]{\norm{#1}_\infry}                                          % inf norm
\newcommand{\eucnorm}[1]{\norm{#1}_2}                                               % euclidean norm
\newcommand{\nnorm}[2]{\norm{#1}_{#2}}                                              % n norm
\newcommand{\psinorm}[2]{\norm{#1}_{\psi_{#2}}}                                     % psi norm
\newcommand{\trace}[1]{\text{tr}\left(#1\right)}                                                   % trace of a matrix
