...
if (ncol(data) < 250) {
    pars_list <- list(0.9, 3, 1e-12, "automatic", 0.99, 0.5, "wmean", FALSE, TRUE, 25000, FALSE, "1stepM", "gkwls", "wrap", 100)
    ...
    pars_list <- list(0.9, 3, 1e-12, "automatic", 0.99, 0.5, "wmean", FALSE, TRUE, 25000, TRUE, "1stepM", "gkwls", "wrap", 100)
    names(pars_list) <- c("fracNA", "numDiscrete", "precScale", "cleanNAfirst", "tolProb","corrlim", "combineRule", "returnBigXimp", "silent", "nLocScale", "fastDDC", "standType", "corrType", "transFun", "nbngbrs")
}
